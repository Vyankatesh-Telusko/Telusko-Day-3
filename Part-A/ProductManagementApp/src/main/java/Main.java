...
*/
//        List<src.main.java.Product> products = service.getAllProducts();
//        for(src.main.java.Product p : products){
...
//
//        src.main.java.Product p = service.getProduct("Logi Mouse");
//        System.out.println(p);
...
*/
        System.out.println("==============================================");
        System.out.println("Search by Name: Logi Mouse");

        List<Product> products = (List<Product>) service.getProduct("Logi Mouse");
